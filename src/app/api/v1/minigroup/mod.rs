...
mod tests {
    mod create {
        ...
        #[sqlx::test]
        async fn create_minigroup_no_time(pool: sqlx::PgPool) {
        ...
        #[sqlx::test]
        async fn create_minigroup_with_time(pool: sqlx::PgPool) {
            let agent = TestAgent::new("web", "user1", USR_AUDIENCE);
        ...
        #[sqlx::test]
        async fn create_minigroup_unauthorized(pool: sqlx::PgPool) {
            let agent = TestAgent::new("web", "user1", USR_AUDIENCE);
        ...
        #[sqlx::test]
        async fn create_minigroup_with_properties(pool: sqlx::PgPool) {
            let agent = TestAgent::new("web", "user1", USR_AUDIENCE);
